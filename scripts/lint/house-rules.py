...
TARGETS = [
    ...
    ("crates/sigil/src", "**/*.rs", "c"),
    ("crates/sigil-proto/src", "**/*.rs", "c"),
    ("crates/sigil-relay-client/src", "**/*.rs", "c"),
    ("crates/sigil-softphone/src", "**/*.rs", "c"),
    ("crates/sigil-direct/src", "**/*.rs", "c"),
    ("crates/sigil-relay/src", "**/*.rs", "c"),
